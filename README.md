...
2) Make_Calibration_Map: Returns the maps of Figure 1, REF TO MANUSCRIPT. Calibration data are 	shown coloured by the chosen CD (default = median) to highlight spatial and temporal 	variations in how data contribute to a GPR prediction.
...
Publications using this code should cite both Allison et al., 2025 andDunkley Jones et al., 2020 in addition to this github repository. The Following data are required to ensure your work is reproducible:
